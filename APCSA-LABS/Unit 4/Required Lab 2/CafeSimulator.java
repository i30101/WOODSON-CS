/**
* The CafeSimulator class works with a small array of tables to test the
ability to seat and clear tables with
* varying party sizes, as well as the ability to block seating of an
unavailable or undersized table.
...
public class CafeSimulator {
    ...
    // Simulates 10 "rounds," alternating between attempting to seat a table and clearing a table in each round.
    public void run(){
        for (int i = 1; i <= 10; i++){
            System.out.println("\n\nTHE GEN WHY PIT");
